...
const noticeList = [
    {
        ...
        name: '빈센조',
        date: '2021.05.05',
        comment: '안녕하세요 스터디장 빈센조입니다! 이번주는 원래 4장까지 읽어오기로 했지만, 3장 길이가 너무 많은 관계로 3장까지만 읽어오는걸로 하겠습니다 :-) 모두 다음주에 만나요! '
    },
    {
        profile: '/assets/main/surprised.svg',
        name: '빈센조',
        date: '2021.05.06',
        comment: '이번주는 개인 사정으로 인하여 스터디를 한 주 쉬어가도록 하겠습니다. 죄송합니다! 다음주에 즐거운 마음으로 만나요 :-)'
    },
    {
        profile: '/assets/main/surprised.svg',
        name: '빈센조',
        date: '2021.05.05',
        comment: '안녕하세요 모두 만나서 반갑습니다. 이번 스터디장을 맡게된 빈센조라고 합니다.\n' +
